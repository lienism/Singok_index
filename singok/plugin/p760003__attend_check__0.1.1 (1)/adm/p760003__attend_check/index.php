...
*/
	...
	//=======================================================
	// 스킨_PC
	$skin_pc_c = $attend_config["skin_pc_c"];


	//=======================================================
	// 스킨_모바일
	$skin_mobile_c = $attend_config["skin_mobile_c"];


	//=======================================================
	// 출석체크__시작_시간
	$start_time_H = $attend_config["start_time_H"];
	$start_time_i = $attend_config["start_time_i"];


	//=======================================================
	// 출석체크__마감__시간
	$close_time_H = $attend_config["close_time_H"];
	$close_time_i = $attend_config["close_time_i"];


	//=======================================================
	// 출석체크__포인트
	$attend_point = $attend_config["attend_point"];


	//=======================================================
	// 개근_날짜__개근_포인트
	$regular_day_n = $attend_config["regular_day_n"];
	$regular_point = $attend_config["regular_point"];


	//=======================================================
	// 1등_포인트
	$rank_1_point = $attend_config["rank_1_point"];
...
<section>
		...
		<form name="level_list" id="level_list" action="./pi__config.update.php" onsubmit="return submit__attend_check(this);" method="post">
...
?>
								<option value="<?=$i?>"<?php	if ($i == $start_time_H) echo " selected";	?>><?=$time_s?></option>
<?php
							}
							// 끝 => 반복문__돌리기
							//===========================================
...
<?php
							...
							{
?>
								<option value="<?=$i?>"<?php	if ($i == $start_time_i) echo " selected";	?>><?=$i?></option>
<?php
							}
							// 끝 => 반복문__돌리기
							//===========================================
...
<?php
							...
							for ($i=0; $i<24; $i++)
							{
								...
								$time_s = $i<13 ? "오전 ".$i : "오후 ".$i;
?>
								<option value="<?=$i?>"<?php	if ($i == $close_time_H) echo " selected";	?>><?=$time_s?></option>
<?php
							}
							// 끝 => 반복문__돌리기
							//===========================================
...
<?php
							...
							{
?>
								<option value="<?=$i?>"<?php	if ($i == $close_time_i) echo " selected";	?>><?=$i?></option>
<?php
							}
							// 끝 => 반복문__돌리기
							//===========================================
...
?>
						...
						<td align="center">
							...
							<input type="text" name="attend_point" value="<?php echo $attend_point; ?>" id="attend_point_label" class="frm_input" size="10"> 점
						</td>

						<td align="center">
							<label for="regular_day_n_label" class="sound_only">개근 날짜</label>
							<input type="text" name="regular_day_n" value="<?php echo $regular_day_n; ?>" id="regular_day_n_label" class="frm_input" size="10"> 점
						</td>

						<td align="center">
							<label for="regular_point_label" class="sound_only">개근 포인트</label>
							<input type="text" name="regular_point" value="<?php echo $regular_point; ?>" id="regular_point_label" class="frm_input" size="10"> 점
						</td>

						<td align="center">
							<label for="rank_1_point_label" class="sound_only">1등 포인트</label>
							<input type="text" name="rank_1_point" value="<?php echo $rank_1_point; ?>" id="rank_1_point_label" class="frm_input" size="10"> 점
						</td>
...
function submit__attend_check(gform)
{
